...
(function (root) {
  const CONSTANTS = {
    ...
    MESSAGE: {
      ...
      GET_PENDING_CLIP: "CLIPMARGINAL_GET_PENDING_CLIP",
      CLEAR_PENDING_CLIP: "CLIPMARGINAL_CLEAR_PENDING_CLIP",
      PENDING_CLIP_UPDATED: "CLIPMARGINAL_PENDING_CLIP_UPDATED",
      OPEN_PANEL: "CLIPMARGINAL_OPEN_PANEL"
    },

    STORAGE_KEY: {
      PENDING_CLIP: "clipmarginal_pending_clip",
